...
public class UIElement {
	...
	static {
		...
		try {
			...
			SCRIPT_GET_ELEMENT_BORDER = FileUtils.readFileToString(new File("./src/main/resource/element_highlight.js"), "UTF-8");
			
			SCRIPT_UNHIGHLIGHT_ELEMENT = FileUtils.readFileToString(new File("./src/main/resource/element_unhighlight.js"), "UTF-8");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
	...
	public synchronized WebElement getWebElement(String elementIdentifier, WebDriver webDriver, SearchBy elementType) {
		...
		switch(elementType) {
			...
			default : System.out.println("Un-Expected Element : " + elementType);  
